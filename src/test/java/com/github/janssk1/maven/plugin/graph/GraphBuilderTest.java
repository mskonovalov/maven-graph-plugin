...
public class GraphBuilderTest extends PlexusTestCase {
    ...
    public void testGraphOfALeafNodeReturnsThatNode() {
        expectGraph("a:1.0");
        checkGraph();
    }
    ...
    public void testGraphOfANodeWithOneDependency() {
        expectGraph("b:1.0");
        expectEdge("b:1.0", "a:1.0", "compile:1.0");
        checkGraph();
    }

    public void testProvidedNodeCanBeHidden() {
    ...
    public void testProvidedNodeCanBeShown() {
    ...
    public void testGraphOfANodeWithAnUnknownDependency() {
        expectGraph("b:1.0-withunknowna");
        expectEdge("b:1.0-withunknowna", "a:unknown", "compile:unknown");
        checkGraph();
    }

    public void testGraphOfANodeWithTransitiveCompileDependency() {
        expectGraph("c:1.0");
    ...
    public void testGraphOfANodeWithTransitiveCompileDependencyThatGetsExcluded() {
        expectGraph("c:1.0-withexcludeda");
        expectEdge("c:1.0-withexcludeda", "b:1.0", "compile:1.0");
        checkGraph();
    }

    public void testGraphOfANodeWithTransitiveCompileDependencyThatGetsOverriddenInDependencyMgnt() {
    ...
    public void testGraphOfANodeWithTransitiveCompileDependencyThatGetsOverriddenByNearerDependency() {
    ...
    public void testNestedProvidedScopeIsIgnored() {
    ...
    public void testNearestDependencyInAnotherBranchIsSelectedAnyway() {
        expectGraph("e:1.0");
